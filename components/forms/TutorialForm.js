...
TutorialForm.propTypes = {
  obj: PropTypes.shape({
    ...
    imagefive: PropTypes.string,
    stepsix: PropTypes.string,
    imagesix: PropTypes.string,
    stepseven: PropTypes.string,
    imageseven: PropTypes.string,
    stepeight: PropTypes.string,
    imageeight: PropTypes.string,
    stepnine: PropTypes.string,
    imagenine: PropTypes.string,
    stepten: PropTypes.string,
    imageten: PropTypes.string,
  }),
};
