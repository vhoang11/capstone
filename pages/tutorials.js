...
function AllTutorials() {
  ...
  return (
    <div className="text-center my-4" style={{ alignItems: 'center' }}>
      ...
      <h1 style={{ marginTop: '50px', marginBottom: '30px' }}>Tutorials</h1>
      ...
      <div id="tutorial-section">
        {tutorials.map((tutorial) => (
          <TutorialCard key={tutorial.firebaseKey} tutorialObj={tutorial} onUpdate={getAllTheTutorials} isMine={tutorial.uid === user.uid} />
        ))}
      </div>
